 ...
 */
@Data
@ApiModel(description = "3.7. 个人用户解绑银行卡 3.7.1. 解绑 请求地址https://accpapi.lianlianpay.com/v1/acctmgr/unlinkedacct-ind-apply")
public class ResUnlinkedacctIndApply implements Serializable {
    private static final long serialVersionUID = -5027824618935676546L;
    /**
