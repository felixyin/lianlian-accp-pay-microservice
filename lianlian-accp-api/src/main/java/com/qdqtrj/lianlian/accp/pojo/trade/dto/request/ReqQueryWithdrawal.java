 ...
 */
@Data
@ApiModel(description = "3.3.4. 提现结果查询 该接口提供所有提现场景下的订单查询，包括提现及代发到银行账户；商户可以通过该接口主动查询订单状态，完成下一步的业务逻辑。请求地址https://accpapi.lianlianpay.com/v1/txn/query-withdrawal")
public class ReqQueryWithdrawal implements Serializable {
    private static final long serialVersionUID = 3788015119467883853L;
    /**
