 ...
 */
@Data
@ApiModel(description = "3.9.2. 验证 请求地址https://accpapi.lianlianpay.com/v1/acctmgr/change-regphone-verify")
public class ReqChangeRegphoneVerify implements Serializable {
    private static final long serialVersionUID = -2527838147959597843L;
    /**
    ...
    @NotBlank()
    @Length(min = 1, max = 32)
    @ApiModelProperty(value = "token,授权令牌,Y,String(32) xxx", required = true)
    ...
    @NotBlank()
    @Length(min = 1, max = 20)
    @ApiModelProperty(value = "verify_code_new,新绑定手机号短信验,Y,String(20),证码", required = true)
